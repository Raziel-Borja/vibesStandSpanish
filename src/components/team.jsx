        ...
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl mx-auto sm:text-center">
                    ...
                    Este es el equipo de desarrolladores de VIBES, estas personas tan importantes son la razón por la cual este proyecto fue posible.
                    </p>
                </div>
                <div className="mt-12">
                    <ul className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
                                ...
                                <li>
                                    ...
                                    <div className="mt-4">
                                        <h4 className="text-lg text-white font-semibold">Raziel Borja</h4>
                                        <p className="text-indigo-600">Desarrollador</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div className="w-full h-60 sm:h-52 md:h-56">
                                        <img
                                            src='/public/gera.jpeg'
                                            className="w-full h-full object-cover object-center shadow-md rounded-xl"
                                            alt=""
                                        />
                                    </div>
                                    <div className="mt-4">
                                        <h4 className="text-lg text-white font-semibold">Gerardo Barrón</h4>
                                        <p className="text-indigo-600">Desarrollador</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div className="w-full h-60 sm:h-52 md:h-56">
                                        <img
                                            src='/public/alexis.jpeg'
                                            className="w-full h-full object-cover object-center shadow-md rounded-xl"
                                            alt=""
                                        />
                                    </div>
                                    <div className="mt-4">
                                        <h4 className="text-lg text-white font-semibold">Alexis Medina</h4>
                                        <p className="text-indigo-600">Desarrollador</p>
                                    </div>
                                </li>
